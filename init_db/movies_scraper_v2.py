...
class MovieScraper:
    ...
    def parse(self, html):
        ...
        try:
            country = [country.find('img', {'class': 'flag'})['title'] for country in content.findAll('div', {'class': 'top-block'})]
        except:
            country = ''
            
        try:
            poster = [poster.find('img', {'alt': 'poster'})['src'] for poster in content.findAll('div', {'class': 'middle-block'})]
        except:
            poster = ''
            ...
            if 'martial arts' in genre:
                ...
                try:
                    ...
                    item = {
                        ...
                        'poster': 'https://en.hkcinema.ru' + poster[index],
